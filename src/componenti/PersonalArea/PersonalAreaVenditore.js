        ...
        return (
            <div>
                <div className="container personal">
                    ...
                    <p><strong>Immobili Venduti da te:</strong><Link to={"/venditore/personal/posted/casa/area"} style={{textDecoration: "none"}}><span className="link">click here</span></Link></p>
                </div>            
            </div>
        )
}
...
export default PersonalAreaVenditore